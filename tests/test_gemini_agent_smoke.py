"""
Smoke test for the live Gemini agent adapter against the cheap, known-good
Python fixture. Requires GEMINI_API_KEY and Docker; skips gracefully if
either is missing.
"""
...
def test_gemini_agent_end_to_end(sandbox_image, local_git_repo_url):
    ...
    result = run_evaluation(
        evaluation_id="gemini-smoke-001",
